    ...
    return (
      <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200 group">
        ...
        <div className="relative bg-gray-100 aspect-square overflow-hidden">
          ...
          {/* Category Badge */}
          <div className={`absolute top-3 left-3 ${badge.bg} ${badge.text} text-xs font-semibold px-2 py-1 rounded-full`}>
            {badge.label}
          </div>
        ...
        <div className="p-4">
          ...
          <div className="flex items-center text-xs text-gray-500 mb-3">
            ...
            <span className="line-clamp-1">{item.location || "Sierra Leone"}</span>
          </div>
          ...
          <>
            <div className="mb-4">
              <p className="text-sm text-gray-600">
                Showing <span className="font-semibold">{filteredListings.length}</span> listing
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {filteredListings.map((item) => (
                <div
                  key={item.id}
                  onClick={() => window.location.href = `/business/${item.id}`}
