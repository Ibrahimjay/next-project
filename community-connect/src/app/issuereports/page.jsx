...
const IssueReportingPage = () => {
  ...
  const categories = [
    { id: 'roads', name: 'Roads & Pavements', icon: '🛣️', color: 'bg-blue-500' },
    { id: 'lighting', name: 'Street Lighting', icon: '💡', color: 'bg-yellow-500' },
    { id: 'waste', name: 'Waste & Recycling', icon: '🗑️', color: 'bg-green-500' },
    { id: 'parks', name: 'Parks & Green Spaces', icon: '🌳', color: 'bg-emerald-500' },
    { id: 'transport', name: 'Public Transport', icon: '🚌', color: 'bg-purple-500' },
    { id: 'safety', name: 'Safety & Security', icon: '⚠️', color: 'bg-red-500' },
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Report local issues and help improve your community</p>
              </div>
            </div>
              ...
              <div className="p-6">
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">What type of issue are you reporting?</h3>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mb-4">
                        We'll use this information to update you on the progress of your report.
                      </p>
                    </div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-blue-900">Review your report</h4>
                          <p className="text-sm text-blue-700 mt-1">
                            <strong>Category:</strong> {categories.find(c => c.id === formData.category)?.name}<br />
                ...
                <div className="flex justify-between pt-6 border-t">
                  ...
                  {currentStep < 3 ? (
                    <button
                      onClick={nextStep}
                      disabled={
                        (currentStep === 1 && (!formData.category || !formData.title || !formData.description)) ||
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                {recentReports.slice(0, 5).map(report => (
                  <div key={report.id} className={`p-3 rounded-lg border-l-4 ${getPriorityColor(report.priority)} bg-gray-50`}>
                    <div className="flex items-start justify-between">
                      ...
                      <div className={`px-2 py-1 rounded-full text-xs font-medium flex items-center space-x-1 ${getStatusColor(report.status)}`}>
